...
# Captured verbatim from a GitHub Actions run: redocly forces ANSI color codes
# in its output there (piped or not), and a reset code lands between the
# location token and "at", which broke an earlier, color-naive _CONFLICT_RE.
_CONFLICT_STDERR_WITH_ANSI = (
    "\x1b[90mbundling code/API_definitions/sample.yaml...\n\x1b[39m[1] "
    "\x1b[41mcode/API_definitions/sample.yaml:21:17\x1b[49m "
    "\x1b[90mat #/paths/~1ping/get/responses/500/content/application~1json/schema\x1b[39m\n\n"
    "Two schemas are referenced with the same name but different content. "
    "Renamed Foo to Foo-2.\n\n"
    "\x1b[90m19 |\x1b[39m             \x1b[90mapplication/json:\x1b[39m\n"
    "\x1b[90m20 |\x1b[39m               \x1b[90mschema:\x1b[39m\n"
    "\x1b[90m21 |\x1b[39m                 "
    "\x1b[31m$ref: '../common/common.yaml#/components/schemas/Foo'\x1b[39m\n"
    ...
    "\x1b[31m❌ Errors encountered while bundling "
    "\x1b[34mcode/API_definitions/sample.yaml\x1b[31m: bundle not created "
    "(use --force to ignore errors).\n\x1b[39m"
)
...
class TestCheckComponentRenamingConflict:
    ...
    def test_conflict_with_ansi_color_codes_is_still_detected(
        ...
        monkeypatch.setattr(
            ...
            Mock(
                return_value=subprocess.CompletedProcess(
                    [], 1, stdout="", stderr=_CONFLICT_STDERR_WITH_ANSI
                )
            ),
        )
