...
**Release PR:** [#{{release_pr_number}}]({{release_pr_url}}) · Snapshot: [`{{snapshot_id}}`]({{snapshot_branch_url}}) · Review: [`{{release_review_branch}}`]({{release_review_branch_url}}){{#src_commit_sha}} · Base: `{{src_commit_sha}}`{{/src_commit_sha}}
